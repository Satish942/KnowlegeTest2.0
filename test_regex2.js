...
const text2 = "Question:1\nWhat is your name?\nAnswer: A";
const text3 = "Question:  1\nWhat is your name?\nAnswer: A";

console.log("Match 1?", res.regex.test(text1));
res.regex.lastIndex = 0;
console.log("Match 2?", res.regex.test(text2));
res.regex.lastIndex = 0;
console.log("Match 3?", res.regex.test(text3));
